...
export GLOBAL_KERNEL_START_INFO_ADDRESS="30"
export GLOBAL_KERNEL_START="31"
...
export GLOBAL_WORKING_DIR_ADDRESS="14"

export GLOBAL_MOUNT_INFO_DISK="dev/mount.txt"
export GLOBAL_MOUNT_INFO_DISK_ADDRESS="15"
export GLOBAL_FILE_DESCRIPTORS_START_ADDRESS="16"
export GLOBAL_FILE_DESCRIPTORS_END_ADDRESS="29"
...
export GLOBAL_FRAME_SIZE="${GLOBAL_NEXT_CMD_ADDRESS}"
