...
export GLOBAL_KERNEL_START_INFO_ADDRESS="50"
export GLOBAL_KERNEL_START="51"
...
# Scheduler and process info range:
export GLOBAL_SCHED_COUNTER_ADDRESS="16"
export GLOBAL_SCHED_PID_ADDRESS="17"
export GLOBAL_CURRENT_PID_INFO_ADDRESS="18"
export GLOBAL_KERNEL_END_INFO_ADDRESS="19"
export GLOBAL_SCHED_PID_INFO_START_ADDRESS="20"
export GLOBAL_SCHED_PID_INFO_END_ADDRESS="29"

# File descriptors:
export GLOBAL_MOUNT_INFO_DISK="dev/mount.txt"
export GLOBAL_MOUNT_INFO_DISK_ADDRESS="30"
export GLOBAL_FILE_DESCRIPTORS_START_ADDRESS="31"
export GLOBAL_FILE_DESCRIPTORS_END_ADDRESS="40"
