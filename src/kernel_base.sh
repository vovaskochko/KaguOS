...
#      2. Use -s=0.5 option or other while running bootloader.sh
...
#      2. Try to adjust jump_if argument to request input from user if the command was not "exit".
...
# TODO
#      1. Write some code to print strings or other actions.
